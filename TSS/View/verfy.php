...
<head>
    ...
    <script type="text/javascript">
        alert("check your email to get verification code");
    </script>
     <script
                   ...
                   <div class="modal-content">
                        <div class="modal-header">
                         ...
                         <div class="modal-body">
                               <form role="form" method="post"  action="../Controller/ResetPassword.php">
		                 ...
		                 <div class="modal-footer">
                            <?php
                         if (isset($_GET['fail'])) {
                            echo"<center>verification code wrong</center>";
                         }
